...
{
    public static function getFlattenPermissions(array $arrayOfPermissions, ?string $globalPrefix = null): array
    {
        $handledPermissions = [];
    ...
    private static function getImplodedPermissions($permission, ?string $prefix): array
    {
